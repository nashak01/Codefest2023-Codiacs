...
function LoginPage() {
    ...
    return (
        ...
        <div class="background_branding">
            ...
            <div><img src={listetingEarLogoBottom} class="bottom_branding login_bottom_branding" alt="Listening Ear Logo" aria-label="Listening Ear Logo"/></div>
        </div>

        <div class="login">
            <form action="">
                <div>
                    <img src={listetingEarLogoMain} class="logo_centeral" alt="Listening Ear Logo" aria-label="Listening Ear Logo"/>
                </div>
                <div class="input_display">
                    <label for="Username">Username</label>
                    <input placeholder="Please Enter Username" class="user_input" type="text" aria-label="Please Enter Username"/>
                </div>
                <div class="input_display">
                    <label for="Password">Password</label>
                    <input placeholder="Please Enter Password" class="user_input" type="password" aria-label="Please Enter Password"/>
                </div>
